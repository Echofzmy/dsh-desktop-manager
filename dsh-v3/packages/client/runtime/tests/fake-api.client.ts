...
export class FakeApiClient implements IApiClient {
  ...
  lastBrowseSignal: AbortSignal | undefined
  ...
  onWorkspaceBrowse: (payload: unknown) => Promise<RpcResponse<{
    relativePath: string
    entries: { name: string; relativePath: string; path: string; kind: 'file' | 'directory'; hidden: boolean }[]
    truncated: boolean
  }>> =
    () => Promise.resolve(ok({ relativePath: '', entries: [], truncated: false }))
  ...
  onWorkspaceDeleteArchivedSession: (payload: unknown) => Promise<RpcResponse<{ deleted: true; archivedSessionIds: SessionId[] }>> =
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    browse: (payload: unknown, signal?: AbortSignal) => {
      this.lastBrowseSignal = signal
      return this.record('workspace.browse', payload, this.onWorkspaceBrowse(payload))
    },
    ...
    deleteArchivedSession: (payload: unknown) =>
      this.record('workspace.deleteArchivedSession', payload, this.onWorkspaceDeleteArchivedSession(payload)),
  }
