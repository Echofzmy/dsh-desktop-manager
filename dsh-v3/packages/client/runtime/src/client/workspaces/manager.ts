...
export class WorkspaceManager {
  ...
  /**
   * Restore an archived session and install the returned archive set.
   ...
   * @returns the wire result.
   */
  async deleteArchivedSession(sessionId: SessionId): Promise<RpcResult<{ deleted: true; archivedSessionIds: SessionId[] }>> {
