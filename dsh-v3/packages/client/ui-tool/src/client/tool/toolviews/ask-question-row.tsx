...
export function AskQuestionRow({ toolName, block, inspect, t }: AskQuestionRowProps) {
  ...
  // failed shape, and the outcome classifier gives both the shared stopped
  // (amber) semantics of any other interrupted tool call — the model already
  // carries that state, so only the verdict summary is overridden here.
