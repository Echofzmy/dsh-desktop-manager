...
import { ESCALATION_TARGETS, ESCALATION_ERROR_CODES, approveEscalation, canonicalPath, escalationError, validateEscalationArgs } from '@deepseek-ai/dsh-sandbox'
...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.tools.register(defineTool({
    ...
    projectSchema: ({ agent }) => {
      ...
      return {
        description: bashDescription(backgroundEnabled, advertise ? escalationModes : []),
