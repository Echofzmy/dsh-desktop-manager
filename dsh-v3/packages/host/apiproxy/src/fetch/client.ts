...
import {
  ...
  workspaceDeleteArchivedSessionValueSchema,
  workspaceBrowseValueSchema,
...
export interface IApiClient {
  ...
  workspace: {
    ...
    browse(payload: RequestPayload<'workspace.browse'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.browse'>>>
    ...
    deleteArchivedSession(payload: RequestPayload<'workspace.deleteArchivedSession'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.deleteArchivedSession'>>>
  }
  skills: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'workspace.browse': workspaceBrowseValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    browse: (payload, signal) => this.callUnary('workspace.browse', payload, signal),
