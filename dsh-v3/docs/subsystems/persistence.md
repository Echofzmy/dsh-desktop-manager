...
/**
 * Permanently delete one materialized cold session. Implementations must
 * serialize this operation against their append/read coordinator and reject
 * while the identity is live or exclusively prepared.
 * @param _id - persisted session to delete.
 * @returns whether a durable artifact existed and was deleted.
 */
