...
import {
  createApiProxy, DEFAULT_COLD_BLANK_PROBE_MAX_BYTES, DEFAULT_WORKSPACE_BROWSE_MAX_ENTRIES,
} from './api-proxy.ts'
import {
...
export class ApiProxyService extends Service implements ApiProxy {
  ...
  static Config: z<Config> = z.object({
    ...
    workspaceBrowseMaxEntries: z.natural().default(DEFAULT_WORKSPACE_BROWSE_MAX_ENTRIES),
  })
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const api = createApiProxy(ctx, {
      ...
      ...(config.workspaceBrowseMaxEntries === undefined
        ? {}
        : { workspaceBrowseMaxEntries: config.workspaceBrowseMaxEntries }),
    })
