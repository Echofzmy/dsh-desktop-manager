...
import {
  ...
  workspaceDeleteArchivedSessionRequestSchema,
  workspaceBrowseRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.browse': { schema: workspaceBrowseRequestSchema, invoke: (api, r, signal) => api.workspace.browse(r, signal) },
  ...
  'workspace.deleteArchivedSession': { schema: workspaceDeleteArchivedSessionRequestSchema, invoke: (api, r) => api.workspace.deleteArchivedSession(r) },
