...
export class FakeApiClient implements IApiClient {
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    browse: (payload: unknown) => this.record('workspace.browse', payload, Promise.resolve(ok({
      relativePath: '',
      entries: [],
      truncated: false,
    }))),
    ...
    deleteArchivedSession: (payload: unknown) => this.record('workspace.deleteArchivedSession', payload, Promise.resolve(ok({
      deleted: true as const, archivedSessionIds: [],
    }))),
  }
