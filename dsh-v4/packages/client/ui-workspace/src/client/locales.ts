...
export const zh = {
  ...
  'files.empty': '此文件夹为空',
  'files.empty.noWorkspaces': '暂无工作区',
  'files.truncated': '条目过多，仅显示开头部分。',
  'files.refresh': '刷新文件列表',
  'files.showHidden': '显示隐藏文件',
  'files.rail.aria': '查看文件',
  ...
  'actions.archivedSession.aria': '归档会话“{name}”的操作',
...
export const en = {
  ...
  'mode.aria': 'Region mode',
  'mode.sessions': 'Sessions',
  'mode.archived': 'Archived',
  'mode.files': 'Files',
  'files.aria': 'Files tree',
  'files.loading': 'Loading files…',
  'files.empty': 'This folder is empty',
  'files.empty.noWorkspaces': 'No workspaces yet',
  'files.truncated': 'Too many entries to list; only the beginning is shown.',
  'files.refresh': 'Refresh files',
  'files.showHidden': 'Show hidden files',
  'files.rail.aria': 'Show files',
  ...
  'delete.session.pending': 'Deleting session permanently…',
  'sessions.count.one': '{n} session',
  'sessions.count.other': '{n} sessions',
  'actions.workspace.aria': 'Workspace actions for {name}',
  'actions.session.aria': 'Session actions for {name}',
  'actions.archivedSession.aria': 'Archived session actions for {name}',
