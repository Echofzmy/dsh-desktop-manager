...
describe('official browser-brand plugin', () => {
  ...
  it('renders dsh with the manager-provided instance badge', () => {
    window.history.replaceState({}, '', '/?dsh-instance=v1')
    const name = render(<OfficialBrandName />)
    expect(name.getByText('dsh')).toBeTruthy()
    expect(name.getByText('v1')).toBeTruthy()
    expect(name.getByText('v1').style.background).toBe('rgb(17, 17, 17)')
    name.unmount()
