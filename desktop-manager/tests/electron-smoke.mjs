...
try {
  ...
  await inlineProviderCard.getByLabel('提供方 ID').click()
  await inlineProviderCard.getByLabel('提供方 ID').press('Meta+A')
  await inlineProviderCard.getByLabel('提供方 ID').pressSequentially(inlineProviderId)
